...
public class Xactware {
	...
	public String requestXmlReport (String sUrlDomain, String sHash, String sDate, String sValId, String sGroupId) {
		...
		sRequestUrl += "ticket_hash=" + sHash + "&ticket_date=" + sDate + "&ticket_groupid=" + sGroupId + "&ticket_userid=" +  sGroupId + "&val_valuationid=" + sValId;
		...
		try {
			...
			connection.setRequestMethod("GET");
			connection.setDoOutput(true);
			// TMG - setReadTimout method not available in java 1.4.2, currently in production as of 5/5/09
			//connection.setReadTimeout(10000);
			connection.connect();
			...
			// read the response into the stringWriter object
			sw = new StringWriter();
			while ((line = rd.readLine()) != null) {
				sw.write(line);
			}

			// explicitly convert the stringWriter object to a string
	...
	public String requestFullXmlReport (String sUrlDomain, String sHash, String sDate, String sValId, String sGroupId) {
