 ...
 */
public class HazardRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.msbinfo.expresslync.rct.valuation.HazardRequest
{
    
    public HazardRequestImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName USESTANDARDIZEDADDRESS$2 = 
        new javax.xml.namespace.QName("", "UseStandardizedAddress");
     ...
     */
    public boolean getUseStandardizedAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(USESTANDARDIZEDADDRESS$2);
            if (target == null)
            {
                return false;
            }
     ...
     */
    public org.apache.xmlbeans.XmlBoolean xgetUseStandardizedAddress()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlBoolean target = null;
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_attribute_user(USESTANDARDIZEDADDRESS$2);
            return target;
        }
    }
     ...
     */
    public void setUseStandardizedAddress(boolean useStandardizedAddress)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(USESTANDARDIZEDADDRESS$2);
            }
            target.setBooleanValue(useStandardizedAddress);
        }
    }
     ...
     */
    public void xsetUseStandardizedAddress(org.apache.xmlbeans.XmlBoolean useStandardizedAddress)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_attribute_user(USESTANDARDIZEDADDRESS$2);
            }
            target.set(useStandardizedAddress);
        }
    }
}
